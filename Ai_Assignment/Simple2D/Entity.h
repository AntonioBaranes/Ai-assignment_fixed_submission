...
enum EntityType { PLATFORM, PLAYER, ENEMY_JUMPER, TRAP, ENEMY, ENEMY_ROTATOR, ENEMY_FOLLOWER, ATTACK };
...
public:
    ...
    void set_landed_true() { landed = true; }
    ...
    void rot_left() { rocketAngle -= 0.005f; }
    void rot_right() { rocketAngle += 0.005f; }
    void decr_speed() { m_speed *= 0.995f; }
    void incr_speed() { m_speed *= 1.0003f; }

    void move_left() { m_movement.x = -0.01f; }
    void move_right() { m_movement.x = 0.01f; }
    void move_up() { m_movement.y = 0.01f; }
    void move_down() { m_movement.y = -0.01f; }
    ...
    float get_rot_angle() const { return rocketAngle; }
    ...
    bool check_landed() { return m_collided_bottom && m_collided_right && m_collided_left; }
